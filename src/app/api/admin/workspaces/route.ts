...
import { loadAdminWorkspaces, recordAdminAudit } from "@/lib/admin-data";
...
export async function GET(request: NextRequest) {
  try {
    ...
    const result = await loadAdminWorkspaces(params);
    ...
    console.error("Admin workspaces list failed:", error);
    return NextResponse.json(
