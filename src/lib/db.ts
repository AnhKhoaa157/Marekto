...
ALTER TABLE "Workspace_subscriptions" ADD COLUMN IF NOT EXISTS provider VARCHAR;
ALTER TABLE "Workspace_subscriptions" ADD COLUMN IF NOT EXISTS provider_customer_id VARCHAR;
ALTER TABLE "Workspace_subscriptions" ADD COLUMN IF NOT EXISTS provider_subscription_id VARCHAR;
ALTER TABLE "Workspace_subscriptions" ADD COLUMN IF NOT EXISTS provider_price_id VARCHAR;
ALTER TABLE "Workspace_subscriptions" ADD COLUMN IF NOT EXISTS cancel_at_period_end BOOLEAN NOT NULL DEFAULT false;
ALTER TABLE "Workspace_subscriptions" ADD COLUMN IF NOT EXISTS last_webhook_event_id VARCHAR;
ALTER TABLE "Workspace_subscriptions" ADD COLUMN IF NOT EXISTS metadata JSONB NOT NULL DEFAULT '{}'::jsonb;
